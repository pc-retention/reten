-- Migration 012: Order statuses — allowed_order_statuses table + calculate_client_stats function
-- Idempotent: uses IF NOT EXISTS, ADD COLUMN IF NOT EXISTS, ON CONFLICT DO UPDATE
